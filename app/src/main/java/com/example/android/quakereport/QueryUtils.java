...
public final class QueryUtils {
    ...
    public static final String USGS_URL="https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&starttime=2016-01-01&endtime=2016-05-02&minfelt=50&minmagnitude=5";
...
*/
    ...
    public static List<quakes> fetchEarthquakeData(String requestUrl) {
        ...
        List<quakes> earthquakes = extractEarthquakes(jsonResponse);
    ...
    public static List<quakes> extractEarthquakes(String json) {
        ...
        try {
                ...
                for(int i=0;i<features.length();i++) {
                    JSONObject currobj = features.optJSONObject(i);
                    ...
                    earthquakes.add(new quakes(mag,place,dfdate.format(dateobj),dftime.format(dateobj),url));
